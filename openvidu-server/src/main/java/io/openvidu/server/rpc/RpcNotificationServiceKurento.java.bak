...
public class RpcNotificationServiceKurento implements RpcNotificationService {

	private static final Logger log = LoggerFactory.getLogger(RpcNotificationServiceKurento.class);
