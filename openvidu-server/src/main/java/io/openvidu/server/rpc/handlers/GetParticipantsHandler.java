...
//                        kParticipant.isMixIncluded());
                ...
                stream.addProperty("streamType", publisher.getStreamType().name());
//                JsonElement filter = publisher.getMediaOptions().getFilter() != null ? publisher.getMediaOptions().getFilter().toJson() : new JsonObject();
