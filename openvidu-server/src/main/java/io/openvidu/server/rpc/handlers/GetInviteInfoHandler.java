...
public class GetInviteInfoHandler extends RpcAbstractHandler {
    ...
    public void handRpcRequest(RpcConnection rpcConnection, Request<JsonObject> request) {
        ...
        if (!StringUtils.startsWith(ruid, "appt-")) {
            ...
            respJson.put("userName", conference.getModeratorName());
            respJson.put("subject", conference.getConferenceSubject());
            respJson.put("startTime", conference.getStartTime());
            respJson.put("roomId", roomId);
            respJson.put("password", conference.getPassword());
            respJson.put("inviteUrl", openviduConfig.getConferenceInviteUrl() + conference.getShortUrl());
