...
public class ProtocolElements {
    ...
    public static final String SET_AUDIO_TARGET_IDS_PARAM = "targetId";
    ...
    public static final String POLLING_CONNECTIONID_PARAM = "targetId";
    ...
    public static final Set<String> FILTERS = new HashSet<>(Arrays.asList(ACCESS_IN_METHOD, CONFIRM_APPLY_FOR_LOGIN_METHOD,
            ...
            GET_FIXED_CONFERENCE_SCHEDULE_METHOD,GET_INVITE_INFO_METHOD)
    );
