...
//	public static final String JOINROOM_TOKEN_PARAM = "token";
	...
	public static final Set<String> THOR_IF_MODERATOR_NOT_FOUND_FILTERS = new HashSet<>(Arrays.asList(
			...
			INVITE_PARTICIPANT_METHOD,SET_PART_OPER_SPEAKER_METHOD,START_CONF_RECORD_METHOD,STOP_CONF_RECORD_METHOD,
			PUT_DOWN_HAND_METHOD,END_ROLL_CALL_METHOD,REPLACE_ROLL_CALL_METHOD,FORCEDISCONNECT_METHOD
	));
